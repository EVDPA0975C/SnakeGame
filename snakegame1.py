...
def display_snake_and_food():
    ...
    pygame.draw.circle(game_screen, GREEN, (food_x + SNAKE_SIZE // 2, food_y + SNAKE_SIZE // 2), SNAKE_SIZE // 2)
    
    # Draw the snake
    for i, (x, y) in enumerate(snake_body):
        if i == len(snake_body) - 1:  # Head of the snake
            pygame.draw.circle(game_screen, RED, (x + SNAKE_SIZE // 2, y + SNAKE_SIZE // 2), SNAKE_SIZE)
        else:  # Body of the snake
            pygame.draw.circle(game_screen, RED, (x + SNAKE_SIZE // 2, y + SNAKE_SIZE // 2), SNAKE_SIZE // 2)
